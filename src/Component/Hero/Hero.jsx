...
function Hero() {
    return (
        <>
            <Navbar />
            <div className="bg-[#08003acd] bg-[url('/Edusity/src/assets/media/hero-wMB5D_Q0.png')] opacity-90 bg-cover bg-center bg-blend-overlay h-screen w-full flex justify-center items-center relative" id='hero'>
